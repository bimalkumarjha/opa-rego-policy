...
severity1 = {"rule_id": "dbuser_excessive_data_activities_critical", "severity": "CRITICAL1"} if {
    dbuser_critical_condition
}
else := {"rule_id": "dbuser_excessive_data_activities_high", "severity": "HIGH1"} if {
    dbuser_high_condition
}
# Rule ID and Severity mappings
else :=  {"rule_id": "dbuser_excessive_data_activities_medium", "severity": "MEDIUM1"} if {
    dbuser_medium_condition
}
else :=  {"rule_id": "dbuser_excessive_data_activities_low", "severity": "LOW1"} if {
...
# Rule ID and Severity mappings
severity2 = {"rule_id": "dbuser_suspicious_activities_critical", "severity": "CRITICAL2"} if {
...
else := {"rule_id": "dbuser_suspicious_activities_high", "severity": "HIGH2"} if {
...
# Rule ID and Severity mappings
else := {"rule_id": "dbuser_suspicious_activities_medium", "severity": "MEDIUM2"} if {
...
else := {"rule_id": "dbuser_suspicious_activities_low", "severity": "LOW2"} if {
...
# Rule ID and Severity mappings
severity3 = {"rule_id": "dbuser_high_outlier_large_activities_critical", "severity": "CRITICAL3"} if {

    dbuser_critical_condition_high_intensity

 }
else := {"rule_id": "dbuser_high_outlier_large_activities_high", "severity": "HIGH3"} if {
        dbuser_high_condition_high_intensity
}
# Rule ID and Severity mappings
else :=  {"rule_id": "dbuser_high_outlier_large_activities_medium", "severity": "MEDIUM3"} if {
    dbuser_medium_condition_high_intensity
}
else :=  {"rule_id": "dbuser_high_outlier_large_activities_low", "severity": "LOW3"} if {
...
severity4 := {"rule_id": "dbuser_high_violation_large_activities_critical", "severity": "CRITICAL4"} if {
	input.dbuser_total_count_activity_hour >= 0.9
	input.dbuser_total_count_activity_day >= 0.8
	dbuser_outlier_or_violation_critical
	dbuser_key_characteristics_critical
} else := {"rule_id": "dbuser_high_violation_large_activities_high", "severity": "HIGH4"} if {
	input.dbuser_total_count_activity_hour >= 0.8
	input.dbuser_total_count_activity_hour < 0.9
	input.dbuser_total_count_activity_day >= 0.6
	input.dbuser_total_count_activity_day < 0.8
...
} else := {"rule_id": "dbuser_high_violation_large_activities_medium", "severity": "MEDIUM4"} if {
	input.dbuser_total_count_activity_hour >= 0.6
	input.dbuser_total_count_activity_hour < 0.8
	input.dbuser_total_count_activity_day >= 0.3
	input.dbuser_total_count_activity_day < 0.6
...
} else := {"rule_id": "dbuser_high_violation_large_activities_low", "severity": "LOW4"} if {
	input.dbuser_total_count_activity_hour >= 0.3
	input.dbuser_total_count_activity_hour < 0.6
	input.dbuser_total_count_activity_day < 0.3
...
severity5 := {"rule_id": "dbuser_high_data_manipulation_high", "severity": "HIGH5"} if {
    dbuser_mandatory_features_high
    input.dbuser_outlier_max_score_summary_hour >= 0.8
    input.dbuser_is_admin_hour == 1
    input.dbuser_sensitive_obj_hour >= 0.8
    input.dbuser_sensitive_obj_day >= 0.6
} else := {"rule_id": "dbuser_high_data_manipulation_medium", "severity": "MEDIUM5"} if {
...
} else := {"rule_id": "dbuser_high_data_manipulation_low", "severity": "LOW5"} if {
...
severity6 = {"rule_id": "dbuser_high_login_medium", "severity": "MEDIUM6"} if {
    dbuser_medium_condition_high_login
}
else := {"rule_id": "dbuser_high_login_low", "severity": "LOW6"} if {
